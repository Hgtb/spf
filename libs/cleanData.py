...
def __cleanStockList(stockListPath):
...
def cleanStockList(stockListPath_SZSE, stockListPath_SSE):
    stock_list_SZSE = __cleanStockList(stockListPath_SZSE)
    stock_list_SSE = __cleanStockList(stockListPath_SSE)
...
def cleanStockData(stockListPath, rawDataPath, outputPath):
...
def cleanData(stockListPath_SZSE=raw_stockList_SZSE, stockListPath_SSE=raw_stockList_SSE, stockListPath=stock_list_path,
              tradeDataPath=raw_data_path, outputPath="../dataSet/daily/"):
    # 传入参数太多了！！
    detectFolder("../dataSet/daily")
    detectFolder("../dataSet/dailyData")
    cleanTradeCal()
    cleanStockList(stockListPath_SZSE, stockListPath_SSE)
    cleanStockData(stockListPath, tradeDataPath, outputPath)


if __name__ == "__main__":
    cleanTradeCal()
    cleanStockList(stockListPath_SZSE=raw_stockList_SZSE, stockListPath_SSE=raw_stockList_SSE)
    cleanStockData(stockListPath=stock_list_path, rawDataPath=raw_data_path, outputPath="../dataSet/daily/")
